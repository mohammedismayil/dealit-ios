...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setInitialVC() {
        ...
        let story = UIStoryboard(name: "Main", bundle:nil)
               let vc = story.instantiateViewController(withIdentifier: "ButtonBackgroundBezierPathDemoViewController") as! ButtonBackgroundBezierPathDemoViewController
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "HomePageUsers")
